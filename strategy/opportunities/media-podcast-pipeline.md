...
- **Competitor landscape:**
  ...
  - *ElevenLabs* — voice synthesis / TTS leader; increasingly used by podcasters for AI dubbing, voice cloning, and foreign-language editions; **raised $500M at $11B valuation (Apr 2026, WSJ)**. Today a complement (AudioText STT → ElevenLabs TTS pipeline), but well-capitalised enough to expand into transcription and podcast automation. High-value integration target in the near term; potential competitor in the medium term.
...
- **New risk (Apr 2026):** ElevenLabs raised $500M Series D at $11B valuation and is deeply embedded in the creator workflow for voice synthesis. If ElevenLabs launches an end-to-end podcast pipeline (STT + chapters + TTS dubbing), it could become a dominant single-vendor solution for creators. Counter-strategy: ship ElevenLabs API integration to position AudioText as the preferred transcription layer *within* ElevenLabs-based workflows before this window closes.
