...
**Revalidation (2026-05-19):** Recurring KrASIA coverage of iFlytek's 100M-user milestone continues to support this as market-scale validation (not a direct near-term competitive threat), so the strategic response above remains unchanged.
